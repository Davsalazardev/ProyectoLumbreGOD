...
function analyzeJavaPatterns(code: string, filename: string): NormalizedIssue[] {
...
export async function analyzeJava(code: string, filename: string): Promise<NormalizedIssue[]> {
  try {
