...
export const reportsService = {
   ...
   */
  async generateExecutiveReport(projectId: string, analysisData: any): Promise<any> {
    return {
      type: 'EXECUTIVE',
   ...
   */
  async generateTechnicalReport(projectId: string, analysisData: any): Promise<any> {
    return {
      type: 'TECHNICAL',
   ...
   */
  async generateRemediationReport(projectId: string, issues: any[]): Promise<any> {
    return {
      type: 'REMEDIATION',
   ...
   */
  async exportReport(report: any, format: 'JSON' | 'PDF' | 'HTML' | 'DOCX'): Promise<any> {
    return {
      format,
      data: report,
      generated: new Date(),
